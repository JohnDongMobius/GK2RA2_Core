...
load data infile "/tmp/Niger_Trunk_DefinitionsV0.3.csv" into table ra_trunk_tmp fields terminated by ',' enclosed by '"' lines terminated by '\r' (@col1,@col2,@col3,@col4,@col5,@col6) set source_operator=@col1,trunk_in=@col2,trunk_out=@col3,interconnect_operator=@col4,traffic_direction=@col5,trunk_scope=@col6;

load data infile "/Users/anmyandy/Workspaces/Workspace4Operators/Niger/doc/Niger_Trunk_DefinitionsV0.3.csv" into table ra_trunk_tmp fields terminated by ',' enclosed by '"' lines terminated by '\r' (@col1,@col2,@col3,@col4,@col5,@col6) set source_operator=@col1,trunk_in=@col2,trunk_out=@col3,interconnect_operator=@col4,traffic_direction=@col5,trunk_scope=@col6;
