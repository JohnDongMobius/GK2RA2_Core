...
#add traffic_type
insert into traffic_type values (1, 'DIRECT');
insert into traffic_type values (2, 'TRANSIT SPECIAL');
insert into traffic_type values (3, 'TRANSIT SPECIAL IN ROAM');
insert into traffic_type values (4, 'INTERNATIONAL');
