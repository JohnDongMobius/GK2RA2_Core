...
load data infile "/Users/anmyandy/Workspaces/Workspace4Operators/Niger/doc/NIGER RETAIL RATE PLAN ProductID V0.6.csv" into table product_id fields terminated by ',' enclosed by '"' lines terminated by '\r' (@col1,@col2,@col3,@col4) set product_ID=@col1,sub_product_ID=@col2,s_num_code=@col3,o_num_code=@col4;

load data infile "/tmp/NIGER RETAIL RATE PLAN ProductID V0.6.csv" into table product_id fields terminated by ',' enclosed by '"' lines terminated by '\r' (@col1,@col2,@col3,@col4) set product_ID=@col1,sub_product_ID=@col2,s_num_code=@col3,o_num_code=@col4;
...
update rate_plan as a, product_id as b set a.product_id=b.product_id where a.s_num_code=b.s_num_code and a.o_num_code=b.o_num_code and a.product_id='';
