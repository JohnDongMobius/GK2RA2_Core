...
drop table ra_trunk_tmp;
 ...
 insert into ra_trunk (source_operator_id,trunk_name,interconnect_operator,traffic_direction,trunk_type,trunk_scope,insert_time) values ('614_4','SONITEL1_OUT','SONITEL','Incoming',1,'Domestic',current_timestamp());
